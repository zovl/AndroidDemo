...
public abstract class ResponseHandler<E> {
     ...
     *
     * @param stream      The response InputStream
     * @param client      The client task. In order to call
     ...
     * @param totalLength The total length of the stream
     ...
     * downloaded.
     *
     * @param chunk          The chunk of data. This will be the <b>null</b> after the total amount has been downloaded.
     * @param chunkLength    The length of the chunk
     * @param totalProcessed The total amount of data processed from the request.
     * @param totalLength    The total size of the request. <b>note:</b> This <i>can</i> be
     *                       -1 during download.
     */
    @WorkerThread
     ...
     *
     * @param totalProcessed The total processed sized of the request
