...
public class PackageHelper {
	...
	public static void tets(PackageManager packageManager) {
	...
	public static String printPackageInfo(Context context, PackageInfo packageInfo) {
		...
		if (packageInfo != null) {
			...
			if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP_MR1) {
                if (packageInfo.splitRevisionCodes != null) {
			...
			buffer.append("signatures=" + packageInfo.signatures + "\n");
			buffer.append("\n");

			Log.d(TAG, "printPackageInfo: " + "\n" + buffer.toString());
	...
	public static String printApplicationInfo(Context context, ApplicationInfo applicationInfo) {
		...
		if (applicationInfo != null) {
			...
			Log.d(TAG, "printApplicationInfo: " + "\n" + "\n" + buffer.toString());
	...
	public static String printActivityInfo(ActivityInfo activityInfo) {
		...
		if (activityInfo != null) {
			...
			Log.d(TAG, "printActivityInfo: " + "\n" + buffer.toString());

			return buffer.toString();
		}
		return "activityInfo is null";
	}
	...
	public static String printServiceInfo(ServiceInfo serviceInfo) {
		...
		if (serviceInfo != null) {
			...
			Log.d(TAG, "printServiceInfo: " + "\n" + buffer.toString());

			return buffer.toString();
		}
		return "serviceInfo is null";
	}
	...
	public static String printProviderInfo(Context context, ProviderInfo providerInfo) {
		...
		if (providerInfo != null) {
			...
			Log.d(TAG, "printProviderInfo: " + "\n" + buffer.toString());

			return buffer.toString();
		}
		return "providerInfo is null";
	}
	 ...
	 * 获取文件应用
	 */
	public static PackageInfo getPackageArchiveInfo(Context context, String apkPath, int flags) {
		Log.d(TAG, "----------------[getPackageArchiveInfo]------------------");
		PackageManager packageManager = context.getPackageManager();
		PackageInfo packageInfo = null;
		try {
			packageInfo = packageManager.getPackageArchiveInfo(apkPath, flags);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return packageInfo;
